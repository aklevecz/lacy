...
<svelte:head>
  ...
  <meta property="og:description" content="Lacy Studio Lofts in Los Angeles, CA. 2684 Lacy St. 90031" />
  <meta property="og:image" content={"/seo-img.png"} />
</svelte:head>
<div
  class={orientationSvelte.state}
  style="display:flex;flex-wrap:wrap;min-height:{orientationSvelte.dimensions.height}px;padding:1rem;"
>
<div class="before" style="flex: 1 0 100%;">
  <h1>LACY STUDIOS</h1>
</div>
  <div class="map" style="display:flex;flex-direction:column;align-items:center;">
